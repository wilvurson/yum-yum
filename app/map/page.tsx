...
const Map = dynamic(() => import('./Map'), {
  ssr: false,
  loading: () => (
    <div className="h-[600px] w-full bg-gray-100 flex items-center justify-center rounded-xl">
...
export default function FoodMapPage() {
  ...
  const [mapCenter, setMapCenter] = useState<[number, number]>([47.9215, 106.9056]);
  ...
  const mongolianRestaurants: Restaurant[] = [
    ...
    },
    {
      ...
      distance: 0.4,
      price: "$$",
      image: "https://images.unsplash.com/photo-1614926779318-f4f4115cee1a?auto=format&fit=crop&w=800&q=80",
      address: "Olympic Street, Ulaanbaatar",
      coordinates: [47.9150, 106.9100],
      isOpen: true,
      tags: ["Indian", "Curry"]
    },
    {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          // Calculate distances
          const restaurantsWithDistance = mongolianRestaurants.map(restaurant => ({
            ...restaurant,
            distance: calculateDistance(location.lat, location.lng, restaurant.coordinates[0], restaurant.coordinates[1])
          }));
      ...
      <div className="px-7 py-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Restaurants in Ulaanbaatar</p>
          </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
              <div className="flex items-center gap-3 mb-4">
                <div className={`w-3 h-3 rounded-full animate-pulse ${userLocation ? "bg-blue-500" : "bg-gray-300"}`}></div>
              ...
              {loading ? (
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-500">Accuracy: ±{userLocation.accuracy.toFixed(0)}m</p>
                  <button 
                    onClick={() => {
                      if (userLocation) {
                ...
                <div className="space-y-4">
                  ...
                  <button 
                    onClick={() => {
                      ...
                      const ubLocation = { lat: 47.9215, lng: 106.9056, accuracy: 0 };
                      setUserLocation(ubLocation);
                      setMapCenter([ubLocation.lat, ubLocation.lng]);
                    }}
                    className="w-full bg-gray-100 text-gray-700 py-2.5 px-4 rounded-lg hover:bg-gray-200 transition-all font-medium"
                  >
            ...
            <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-6 shadow-lg text-white">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-xl">{filteredRestaurants.length}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-blue-100">Open</span>
                  <span className="font-bold text-xl">{filteredRestaurants.filter(r => r.isOpen).length}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-blue-100">Avg Rating</span>
                  <span className="font-bold text-xl">⭐ {filteredRestaurants.length > 0 ? (filteredRestaurants.reduce((a, b) => a + b.rating, 0) / filteredRestaurants.length).toFixed(1) : "N/A"}</span>
                </div>
              </div>
            </div>
          </div>
            ...
            {viewMode === "map" ? (
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div className="p-4 border-b border-gray-100 flex items-center justify-between">
                  <div>
                    <h2 className="text-xl font-bold text-gray-900">Map - Ulaanbaatar</h2>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-3 py-1 bg-red-100 text-red-700 rounded-full text-sm font-medium">
                      {filteredRestaurants.filter(r => !r.isOpen).length} Closed
                    </span>
                  </div>
                </div>
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 mt-2 text-xs text-gray-500">
                            <span className="flex items-center gap-1">📍 {restaurant.distance} km</span>
                            <span className="flex items-center gap-1">💰 {restaurant.price}</span>
                          </div>
            ...
            {selectedRestaurant && (
              <div className="mt-6 bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <span className="text-gray-600">{selectedRestaurant.distance} km</span>
                        <span className="text-gray-400">•</span>
                ...
                <div className="flex gap-3 mt-6">
                  ...
                  <button className="flex-1 bg-gray-100 text-gray-700 py-3 px-4 rounded-xl font-bold hover:bg-gray-200 transition-all">
                    Call
                  </button>
                </div>
              </div>
